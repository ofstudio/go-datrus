...
type Region struct {
	...
	// Пример: "02000000000" (Республика Башкортостан)
	Code string
	...
	// Код ОКАТО региона.
	// Примеры: "05000000000" (Приморский край),"71140000000" (Ямало-Ненецкий автономный округ)
	OKATO string

	// Код ОКТМО региона.
	// Примеры: "05000000000" (Приморский край),"71900000000" (Ямало-Ненецкий автономный округ)
	OKTMO string
}
